...
t-rex.exe -d 0,2 -a ethash -o stratum+ssl://%URL% -u %USER% -p x -w %WORKER% --lhr-low-power --api-bind-http 0.0.0.0:3333 --mclock 700  --fan t:65[85-100]
pause
goto End
:: ------------------ trexminer End --------------------------------
